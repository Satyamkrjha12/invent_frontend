...
export default function LandingHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-orange-50 shadow-sm backdrop-blur-xl bg-opacity-95">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <Link href="/" className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold text-gray-900 md:text-xl font-sans">
            Stock & Warehouse
          </h2>
        </Link>
