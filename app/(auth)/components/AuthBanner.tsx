...
export default function AuthBanner() {
  ...
  return (
    <div
      className="
        w-full rounded-[28px] p-6 lg:p-8 s" >
      {/* Badge */}
      <div className="mb-4 inline-flex w-fit items-center rounded-full border order-orange-200 bg-[#FFF4EE] px-3 py-1.5 text-xs font-medium text-[#FF5A1F]">
      ...
      <p className="mt-4 max-w-lg text-base leading-relaxed text-slate-600">
        Track inventory, manage warehouses, control team access and
        streamline operations with a platform built for modern
        businesses.
      </p>
      ...
      <div className="mt-6 grid grid-cols-2 gap-3">
        {stats.map((stat) => (
          <div
            ...
            "
          >
            <h3 className="text-2xl font-black text-[#FF5A1F]">
              {stat.value}
            </h3>
