...
import { Plus, Trash2, ArrowLeft, ArrowRight, Layers } from "lucide-react";
import { useOnboarding, LocationData } from "@/context/OnboardingContext";

export default function Locations() {
  const { sites, locations, setLocations, nextStep, backStep } = useOnboarding();
