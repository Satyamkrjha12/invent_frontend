...
const NAV_ITEMS = [
  ...
  { id: "inventory", name: "Inventory", icon: ClipboardList, badge: "12" },
    ...
    <div className="flex h-full flex-col justify-between bg-slate-900 text-slate-300">
      ...
      <div className="border-t border-slate-800 p-4">
        <div className="rounded-2xl bg-slate-800/40 p-3 flex items-center gap-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-orange-500/10 text-orange-500 font-bold text-sm">
            AC
          </div>
          <div className="min-w-0 flex-1">
            <h4 className="truncate text-xs font-bold text-white">Acme Warehouse</h4>
            <p className="truncate text-[10px] text-slate-500 font-medium">Starter • 2 Sites</p>
          </div>
          <Link
            href="/signin"
