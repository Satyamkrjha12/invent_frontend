...
export default function TestimonialsSection() {
  return (
    <section id="reviews" className="py-32 bg-gradient-to-b from-orange-50 via-white to-[#FFFAF7]">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto mt-6 max-w-3xl text-center">
          <h2 className="text-4xl font-black tracking-tight text-slate-900 md:text-6xl font-sans">
            Trusted by growing{" "}
          ...
          <p className="mt-6 text-lg text-gray-600 font-sans">
            Thousands of businesses rely on our inventory platform to manage
            products, warehouses, suppliers, and teams.
          </p>
        </div>
