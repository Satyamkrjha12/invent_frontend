  ...
  return (
    <section id="home" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-12 pb-12 text-center">
        ...
        >
          <button className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-orange-500 to-orange-400 px-8 py-4 font-semibold text-white shadow-lg shadow-orange-200 transition-all hover:scale-[1.02]">
            Start Onboarding Wizard
            <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
          </button>

          <button className="inline-flex items-center justify-center gap-2 rounded-2xl border border-gray-200 bg-white px-8 py-4 font-semibold text-gray-700 shadow-sm transition-all hover:border-orange-200 hover:bg-orange-50">
